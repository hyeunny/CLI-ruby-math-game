...
When the game starts, asks for Player 1â€™s name, and then Player 2â€™s name. From that point on, use their names instead of `"Player 1"` or `"Player 2"` when prompting them.
